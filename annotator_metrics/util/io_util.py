...
def read_run_config(config_path):
    ...
    Returns:
        Dicts of required_settings and optional_settings
    """
    ...
    with open(f"{config_path}/run-config.yaml") as f:
        ...
        if "crop" not in optional_settings:
            optional_settings["crop"] = "all"
...
def parser_params():
    ...
    parser = argparse.ArgumentParser(
        description="Code to calculate inter- and intra- annotator metrics and compare to predictions and refinements"
    )
    parser.add_argument(
        "config_path",
        type=str,
